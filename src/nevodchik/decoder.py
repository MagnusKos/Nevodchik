...
class Decoder(ABC):
    ...
    def __init__(self, next_decoder: Optional['Decoder'] = None):
    ...
    def handle(self, topic: str, payload: bytes) -> Optional[Dict[str, Any]]:
...
def build_decoder_chain() -> Decoder:
    ...
    from .decoder_meshtastic import MeshtasticDecoder
    
    meshtastic = MeshtasticDecoder()
